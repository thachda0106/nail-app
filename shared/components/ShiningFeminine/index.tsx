...
const ShiningFeminine = () => {
  ...
  return (
    <Box
      component={"section"}
      className={
        "relative w-full md:after:bg-smoke-primary after:absolute after:w-full after:left-0 after:top-0 after:h-full after:max-w-[1080px] mt-20 after:-z-10 px-5 md:px-0"
      }
