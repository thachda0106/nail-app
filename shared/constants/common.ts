...
export const PRICE_DESCRIPTION = "Make your day shine with your shiny nails";

export const BEAUTIFUL_ID_HREF = "BEAUTIFUL_ID_HREF";
export const BEAUTIFUL_TITLE = "IMAGES GALLERY";
export const BEAUTIFUL_DESCRIPTION = "Stop Time. Stay Beautiful";

export const REVEAL_COLOURFUL_ID_HREF = "REVEAL_COLOURFUL_ID_HREF";
